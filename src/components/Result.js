...
const Result = () => {
    ...
    const isPassing = marks > quizs.length / 2;
    const resultText = isPassing ? 'Awesome!' : 'Oops!';
    const resultClass = isPassing ? 'bg-success' : 'bg-danger';
            ...
            <div className="container">
                <div className="row vh-100 align-items-center justify-content-center">
                    <div className="col-lg-6">
                        <div className={`text-light text-center p-5 rounded ${resultClass}`}>
